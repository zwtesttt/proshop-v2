...
//                     <Button variant="link" onClick={() => toggleCollapse(review._id)}>
//                       {reviewCollapse[review._id] ? 'Collapse' : 'Read More'}
//                     </Button>
//                   )}
//                       </>
//                     ) : (
...
const ProductScreen = () => {
  ...
  const [reviewCollapse, setReviewCollapse] = useState({});
                    ...
                    {reviewCollapse[review._id] ? (
                      <>
                        ...
                        {review.comment.length > 50 && (
                          <Button
                            variant='link'
                            onClick={() => toggleCollapse(review._id)}
                          >
                            {reviewCollapse[review._id] ? 'Collapse' : 'Read More'}
                          </Button>
                        )}
